...
<div class="container-fluid" style="border: solid; border-style: solid;border-width: 5px">
    <div class="col-lg-12">
        ...
        <?php
           ...
           {
            ?>
            <button type="button" class="btn btn-success"><a href="invitation.php?sid=<?php echo $row['sid']; ?>"><?php echo $row['sid']; ?></a></button>
            <?php
            }
            else
             {
            ?>
            <button type="button" class="btn btn-danger"><a href="invitation.php?sid=<?php echo $row['sid']; ?>"><?php echo $row['sid']; ?></a></button>
            <?php 
 ...
 <?php
        ...
        extract($_GET);
        $pid=$_GET['sid'];
        $sql="select * from resultfinal where sid='$sid'";
        $result=$conn->query($sql);
        $row=$result->fetch_assoc();
        $sql1="select * from evacriteria";
        $result1=$conn->query($sql1);
...
<table class="table .table-hover">
    <thead>
      <tr>
        ...
        <th>C5</th>
        <th>C6</th>
        <th>Total/<input type="text" name="totalmarks" id="totalmarks" value="<?php echo $row['atc'];?>" ></th>
    ...
    <tbody>
      ...
      <tr>
        <td style="color: black;font:bold;"><input type="text" name="std" value="<?php echo $row['sid'];?>" readonly> </td>
        ...
        <td><input type="number" class="form-control" name="c1" id="c1" value="<?php echo $row['c1m'];?>" /></td>
        <td><input type="number" class="form-control" name="c2" id="c2" value="<?php echo $row['c2m'];?>" /></td>
        <td><input type="number" class="form-control" name="c3" id="c3" value="<?php echo $row['c3m'];?>" /></td>
        <td><input type="number" class="form-control" name="c4" id="c4" value="<?php echo $row['c4m'];?>" /></td>
        <td><input type="number" class="form-control" name="c5" id="c5" value="<?php echo $row['c5m'];?>" /></td>
        <td><input type="number" class="form-control" name="c6"  id="c6" value="<?php echo $row['c6m'];?>" /></td>
         <td><input type="text" name="tc" id="tc" value="<?php echo $row['ctm'];?>"  readonly></td>
